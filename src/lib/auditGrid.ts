...
export const AUDIT_METRICS: GridMetricDef[] = [
  ...
  { key: 'combined_ratio_igaap', label: 'Combined ratio (IGAAP)', category: 'Ratios', unit: '%', usage: ['SAHI Analysis', 'Company-Specific Analysis'], store: 'combined_ratio_igaap', annual: 'combined_ratio' },
  { key: 'combined_ratio_ifrs', label: 'Combined ratio (IFRS)', category: 'Ratios', unit: '%', usage: ['SAHI Analysis'], store: 'combined_ratio_ifrs' },
